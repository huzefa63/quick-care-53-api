const stripe = require("stripe")('ssk_test_51RCHkERqyP2tLMLl1lEmVC6YVgQXcQmzW44Wg7YMDJLsfZgCideUr0mMbVCmGVlOwiFuIOekzIl1CTuKBGYfOxyl00nYf2kELs');
    ...
    line_items: [
      {
        price_data: {
          currency: "inr",
          unit_amount: 300 * 100, // amount in paise
          product_data: {
            name: doctor.name,
